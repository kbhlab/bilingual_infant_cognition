...
tab_model(final_model_pre, 
          ...
          show.icc = FALSE, 
          title = TAB_TITLE,
          file = here(paste0("output/table_figure/glermodel_training_", 
                             dataset, ".doc"))) 
...
tab_model(final_model_post, 
          ...
          show.icc = FALSE, 
          title = TAB_TITLE, 
          file = here(paste0("output/table_figure/glermodel_test_", dataset,
                             ".doc")))
...
ggsave(here(paste0("output/table_figure/plot_by_trial_", study, "_", filtered_name, ".png")), width = 9, height = 4)
...
apa.ezANOVA.table(pre_7,
                  ...
                  filename = here(paste0("output/table_figure/anova_table_training_", dataset, ".doc")))
...
apa.ezANOVA.table(post_7,
                  ...
                  filename = here(paste0("output/table_figure/anova_table_test_", dataset, ".doc")))
...
block_data %>%
  ...
  apa.2way.table(iv1 = block_num, 
               ...
               filename = here(paste0("output/table_figure/means_table_training_", dataset, ".doc")),
               table.number = 4)
...
block_data %>%
  ...
  apa.2way.table(iv1 = block_num, 
               ...
               data = ., 
               show.marginal.means = FALSE,
               filename = here(paste0("output/table_figure/means_table_test_", dataset, ".doc")),
               table.number = 4)
